...
TEST_CASE("[Shift scaled variance: mu=3, lambda=2, v=0]", "[statistics]") {
    double expected = 1.333;
    double v = 0.0;
    auto variance = cosine_power_mathematical_variance(v, 3.0, 2.0);
    CHECK(round(variance*1000)/1000 == expected);

}
TEST_CASE("[Shift scaled variance: mu=3, lambda=2, v=1]", "[statistics]") {
    double expected = 0.758;
    double v = 1.0;
    auto variance = cosine_power_mathematical_variance(1, 3.0, 2.0);
    CHECK(round(variance*1000)/1000 == expected);

}
TEST_CASE("[Shift scaled variance: mu=3, lambda=2, v=2]", "[statistics]") {
...
TEST_CASE("[Shift scaled variance: mu=3, lambda=2, v=3]", "[statistics]") {
...
TEST_CASE("[Shift scaled variance: mu=3, lambda=2, v=4]", "[statistics]") {
...
TEST_CASE("[Shift scaled variance: mu=3, lambda=2, v=5]", "[statistics]") {
...
TEST_CASE("[Shift scaled variance: mu=3, lambda=2, v=6]", "[statistics]") {
...
TEST_CASE("[Shift scaled excess: mu=3, lambda=2, v=0]", "[statistics]") {
    double expected = -1.200;
    double v = 0.0;
    auto variance = cosine_power_mathematical_excess(v, 3.0, 2.0);
    CHECK(round(variance*1000)/1000 == expected);

}

TEST_CASE("[Shift scaled excess: mu=3, lambda=2, v=1]", "[statistics]") {
...
TEST_CASE("[Shift scaled excess: mu=3, lambda=2, v=2]", "[statistics]") {
...
TEST_CASE("[Shift scaled excess: mu=3, lambda=2, v=3]", "[statistics]") {
...
TEST_CASE("[Shift scaled excess: mu=3, lambda=2, v=4]", "[statistics]") {
...
TEST_CASE("[Shift scaled excess: mu=3, lambda=2, v=5]", "[statistics]") {
...
TEST_CASE("[Shift scaled excess: mu=3, lambda=2, v=6]", "[statistics]") {
    double expected = -0.278;
    double v = 6.0;
    auto variance = cosine_power_mathematical_excess(v, 3.0, 2.0);
    CHECK(round(variance*1000)/1000 == expected);
