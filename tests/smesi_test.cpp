...
TEST_CASE("[Mixtures density: mu1=mu2=5, l1=l2=2, p=0.3, v=1]", "[smesi]"){
    distribution d1{1.0, 5.0, 2.0};
    distribution d2{1.0, 5.0, 2.0};
    double expected = -0.278;
    auto func = mixture_density(d1, d2, 0.3);
    CHECK(round(func(0)*1000)/1000 == expected);
}

TEST_CASE("[Mixtures density: mu1=mu2=5, l1=l2=2, p=0.3, v=2]", "[smesi]"){
    distribution d1{2.0, 5.0, 2.0};
    distribution d2{2.0, 5.0, 2.0};
    double expected = 0.25;
    auto func = mixture_density(d1, d2, 0.3);
    CHECK(round(func(0)*1000)/1000 == expected);
}

TEST_CASE("[Mixtures density: mu1=mu2=5, l1=l2=2, p=0.3, v=3]", "[smesi]"){
    distribution d1{3.0, 5.0, 2.0};
    distribution d2{3.0, 5.0, 2.0};
    double expected = -0.208;
    auto func = mixture_density(d1, d2, 0.3);
    CHECK(round(func(0)*1000)/1000 == expected);
}

TEST_CASE("[Mixtures density: mu1=mu2=5, l1=l2=2, p=0.3, v=4]", "[smesi]"){
    distribution d1{4.0, 5.0, 2.0};
    distribution d2{4.0, 5.0, 2.0};
    double expected = 0.167;
    auto func = mixture_density(d1, d2, 0.3);
    CHECK(round(func(0)*1000)/1000 == expected);
}

TEST_CASE("[Mixtures density: mu1=mu2=5, l1=l2=2, p=0.3, v=5]", "[smesi]"){
    distribution d1{5.0, 5.0, 2.0};
    distribution d2{5.0, 5.0, 2.0};
    double expected = -0.130;
    auto func = mixture_density(d1, d2, 0.3);
    CHECK(round(func(0)*1000)/1000 == expected);
}

TEST_CASE("[Mixtures density: mu1=mu2=5, l1=l2=2, p=0.3, v=6]", "[smesi]"){
    distribution d1{6.0, 5.0, 2.0};
    distribution d2{6.0, 5.0, 2.0};
    double expected = 0.1;
    auto func = mixture_density(d1, d2, 0.3);
    CHECK(round(func(0)*1000)/1000 == expected);
}
